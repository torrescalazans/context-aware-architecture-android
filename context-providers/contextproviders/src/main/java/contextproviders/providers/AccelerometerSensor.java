 ...
 */
public final class AccelerometerSensor extends ContextDataProvider {

    // Sets the log tag
    private static final String TAG = "AccelerometerSensor";

    public AccelerometerSensor(ContextDataRequest contextDataRequest,
    ...
    public int getProviderId() {
        Log.v(TAG, "getProviderId(): " + ContextProvidersConstants.Providers.ACCELEROMETER);

        return ContextProvidersConstants.Providers.ACCELEROMETER;
    }
